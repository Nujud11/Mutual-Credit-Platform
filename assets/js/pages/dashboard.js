import {
  ...
  export function renderDashboard(
    ...
    <section class="mq-info-card">

      <div class="mq-info-icon">
        ...
        >
          ...
          <path d="M12 2 20 7 12 12 4 7 12 2Z"></path>

          <path d="M4 12 12 17 20 12"></path>

          <path d="M4 17 12 22 20 17"></path>

        </svg>

      </div>

      <div class="mq-info-content">

        <div class="mq-info-heading">

          <div>

            <span class="mq-info-label">
              رصيد شبكة مقاصة
            </span>
        ...
        <p>
          ...
          هو الرصيد الرقمي الداخلي لمنصة
          <strong>مقاصة</strong>،
          ويستخدم لتبادل الخدمات بين
          المنشآت الأعضاء داخل الشبكة.

          ويمثل قيمة الخدمات المتبادلة
          دون الحاجة إلى الدفع النقدي
          الفوري لكل معاملة.
