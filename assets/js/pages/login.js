    ...
    <div class="auth-page">
      ...
      <section class="auth-visual">
        ...
        <div class="auth-visual-content">
          ...
          <div class="auth-project-identity">
            <h1 class="auth-project-name">
              مقاصة
            </h1>

            <p class="auth-project-subtitle">
              منصة المقاصة اللامركزية
            </p>
          </div>
          ...
          <p class="auth-visual-slogan">
            تبادل الخدمات، وحقق توازنًا ماليًا أذكى
          </p>
